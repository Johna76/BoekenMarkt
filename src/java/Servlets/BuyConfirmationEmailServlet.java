 ...
 * @author Johna
 */
public class BuyConfirmationEmailServlet extends HttpServlet {

    @EJB
    MailSenderEJB mailSender;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //int aangBoekId = Integer.parseInt(request.getParameter("AangBoekId"));
        ...
        try {
            ...
            Logger.getLogger(BuyConfirmationEmailServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
